...
export const BUSINESS_ICONS: IconData[] = [
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z M12 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" fill="currentColor"/>
    </svg>`,
  },
  {
    id: 'website',
  ...
  },
  {
    ...
    name: 'YouTube',
    category: 'social',
    keywords: ['youtube', 'video', 'social', 'play', 'yt'],
    svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M21.8 8.001c.2 1.2.2 2.398.2 3.999s0 2.8-.2 3.999c-.11.77-.77 1.43-1.54 1.54C18.2 17.8 15.2 18 12 18s-6.2-.2-8.06-.46c-.77-.11-1.43-.77-1.54-1.54C2.2 14.8 2.2 13.6 2.2 12s0-2.8.2-3.999c.11-.77.77-1.43 1.54-1.54C5.8 6.2 8.8 6 12 6s6.2.2 8.06.46c.77.11 1.43.77 1.54 1.54z M10.5 9.5v5l4.5-2.5-4.5-2.5z" fill="currentColor"/>
    </svg>`,
  },
  {
    id: 'star',
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8.21 13.89 7 23l5-3 5 3-1.21-9.11" stroke="currentColor" stroke-width="2" fill="none"/>
    </svg>`,
  },
]
